...
* a working [Python 3.8](https://www.python.org/downloads/) development environment ([Mac getting started guide](http://hackercodex.com/guide/python-development-environment-on-mac-osx/), [Windows getting started guide](https://docs.battlesnake.com/tutorials/python))
