...
A simple [BattleSnake AI](http://battlesnake.io) written in Python. For full documentation on developing and competing with this AI, visit [battlesnake.io/readme](http://battlesnake.io/readme).
