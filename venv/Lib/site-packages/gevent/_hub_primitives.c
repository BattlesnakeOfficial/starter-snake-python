...
/* "src/gevent/_hub_primitives.py":115
 *         self._count = len(objects) if count is None else min(count, len(objects))
 * 
 *     def _begin(self):             # <<<<<<<<<<<<<<
 *         if self._begun:
...
static PyObject *__pyx_f_6gevent_16__hub_primitives_13_WaitIterator__begin(struct __pyx_obj_6gevent_16__hub_primitives__WaitIterator *__pyx_v_self) {
  ...
  /* "src/gevent/_hub_primitives.py":116
 * 
 *     def _begin(self):
 *         if self._begun:             # <<<<<<<<<<<<<<
 *             return
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "src/gevent/_hub_primitives.py":143
 *         self._count -= 1
 *         try:
 *             item = self._waiter.get()             # <<<<<<<<<<<<<<
 *             self._waiter.clear()
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":212
 *     # QQQ would be nice to support iterable here that can be generated slowly (why?)
 *     hub = get_hub()
 *     if objects is None:             # <<<<<<<<<<<<<<
 *         return [hub.join(timeout=timeout)]
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "src/gevent/_hub_primitives.py":213
 *     hub = get_hub()
 *     if objects is None:
 *         return [hub.join(timeout=timeout)]             # <<<<<<<<<<<<<<
 *     return _WaitIterator(objects, hub, timeout, count)
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":214
 *     if objects is None:
 *         return [hub.join(timeout=timeout)]
 *     return _WaitIterator(objects, hub, timeout, count)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":254
 *         hub = get_hub()
 *         return hub.join(timeout=timeout) # pylint:disable=
 *     return list(iwait_on_objects(objects, timeout, count))             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_f_6gevent_16__hub_primitives__primitive_wait(PyObject *__pyx_v_watcher, PyObject *__pyx_v_timeout, PyObject *__pyx_v_timeout_exc, struct __pyx_obj_6gevent_16__hub_primitives_WaitOperationsGreenlet *__pyx_v_hub) {
  ...
  /* "src/gevent/_hub_primitives.py":263
 * 
 * def _primitive_wait(watcher, timeout, timeout_exc, hub):
 *     if watcher.callback is not None:             # <<<<<<<<<<<<<<
 *         raise ConcurrentObjectUseError('This socket is already used by another greenlet: %r'
 ...
 */
    ...
    /* "src/gevent/_hub_primitives.py":272
 *     if timeout is None:
 *         hub.wait(watcher)
 *         return             # <<<<<<<<<<<<<<
 * 
    ...
    /*try:*/ {
      {
        ...
        /*try:*/ {
          ...
          /* "src/gevent/_hub_primitives.py":281
 * 
 *     with timeout:
 *         hub.wait(watcher)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "src/gevent/_hub_primitives.py":288
 *         # test__hub TestCloseSocketWhilePolling, on Python 2; Python 3
 *         # catches the EBADF differently.
...
/* "src/gevent/_hub_primitives.py":320
 * 
 * 
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":336
 *         return wait_on_watcher(io, timeout, timeout_exc, hub)
 *     finally:
 *         io.close()             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_f_6gevent_16__hub_primitives_wait_readwrite(PyObject *__pyx_v_fileno, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_6gevent_16__hub_primitives_wait_readwrite *__pyx_optional_args) {
  ...
  /* "src/gevent/_hub_primitives.py":380
 *     """
 *     # pylint:disable=unused-argument
 *     hub = get_hub()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":381
 *     # pylint:disable=unused-argument
 *     hub = get_hub()
 *     io = hub.loop.io(fileno, 3)             # <<<<<<<<<<<<<<
 *     try:
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":382
 *     hub = get_hub()
 *     io = hub.loop.io(fileno, 3)
 *     try:             # <<<<<<<<<<<<<<
 *         return wait_on_watcher(io, timeout, timeout_exc, hub)
 ...
 */
  /*try:*/ {
    ...
    /* "src/gevent/_hub_primitives.py":383
 *     io = hub.loop.io(fileno, 3)
 *     try:
 *         return wait_on_watcher(io, timeout, timeout_exc, hub)             # <<<<<<<<<<<<<<
 *     finally:
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":385
 *         return wait_on_watcher(io, timeout, timeout_exc, hub)
 *     finally:
 *         io.close()             # <<<<<<<<<<<<<<
 * 
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_ptype_6gevent_16__hub_primitives_greenlet = __Pyx_ImportType(__pyx_t_1, "greenlet", "greenlet", sizeof(PyGreenlet), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6gevent_16__hub_primitives_greenlet) __PYX_ERR(3, 19, __pyx_L1_error)
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_WaitIterator, (PyObject *)&__pyx_type_6gevent_16__hub_primitives__WaitIterator) < 0) __PYX_ERR(0, 98, __pyx_L1_error)
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("gevent.__waiter"); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  /* "src/gevent/_hub_primitives.py":256
 *     return list(iwait_on_objects(objects, timeout, count))
 * 
 * _timeout_error = Exception             # <<<<<<<<<<<<<<
 * 
